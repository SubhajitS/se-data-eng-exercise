WITH CURATED_DATA AS (
    SELECT 
        ...
        SAFE.PARSE_JSON(genres) AS genres,
        ...
        SAFE.PARSE_JSON(production_companies) AS production_companies,
        SAFE.PARSE_JSON(production_countries) AS production_countries,
        ...
        SAFE.PARSE_JSON(spoken_languages) AS spoken_languages,
